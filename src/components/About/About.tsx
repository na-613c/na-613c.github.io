            ...
            <Row  justify="center" align="middle">
                ...
                <Col xs={{span: 20}} sm={{span:14}} md={{span:22}} lg={{span:16}} xl={{span:12}}>
                    ...
                    <Paragraph>
                        ...
                        React-Redux, MobX, Rest API. Работал с такими дизайн-системами как Ant Design и Bootstrap. Так же
                        взаимодействовал с jQuery и Node.js, в том числе делал парсер сайта и бота для Discord.
                        Проходил курсы Cisco: Introduction to Cybersecurity, Cybersecurity Essentials, CCNA R&S: Introduction to
                        Networks.
                    </Paragraph>
                    <Paragraph>
